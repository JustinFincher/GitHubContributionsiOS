...
- (void) triggerSuccessNotificationWithData:(NSMutableArray *)dataArray
{
    ...
    UNNotificationAction *shareAction = [UNNotificationAction actionWithIdentifier:@"shareCommits" title:@"I want to share this! 😎" options:UNNotificationActionOptionForeground];
